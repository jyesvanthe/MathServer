...
<h1 align="center">Jyesvanthe 212223110018</h1>
...
def surfacearea(request):
    ...
    if request.method == 'POST':
        ...
        context['h'] = h
        print('Area=',area)
    return render(request,'max/max.html',context)
...
## HOMEPAGE:
![Screenshot 1](https://github.com/jyesvanthe/MathServer/assets/150319392/2c2e40a0-24ed-4b33-8821-6518c99b501f)
